      ...
      <main class="posts-listing col-lg-8"> 
        <div class="container">
          <div class="row">
            ...
            <!-- post             -->
            <div class="post col-xl-6">
              <div class="post-thumbnail"><a href="{{route('blog.mockup.post')}}"><img src="{{url('/')}}/templates/bootstrap-blog-1-2-1/distribution/img/blog-post-2.jpg" alt="..." class="img-fluid"></a></div>
              <div class="post-details">
                <div class="post-meta d-flex justify-content-between">
                  <div class="date meta-last">20 May | 2016</div>
                  <div class="category"><a href="#">Business</a></div>
            ...
            <!-- post             -->
            <div class="post col-xl-6">
              <div class="post-thumbnail"><a href="{{route('blog.mockup.post')}}"><img src="{{url('/')}}/templates/bootstrap-blog-1-2-1/distribution/img/blog-post-3.jpeg" alt="..." class="img-fluid"></a></div>
              <div class="post-details">
                <div class="post-meta d-flex justify-content-between">
                  <div class="date meta-last">20 May | 2016</div>
                  <div class="category"><a href="#">Business</a></div>
            ...
            <!-- post -->
            <div class="post col-xl-6">
              <div class="post-thumbnail"><a href="post.html"><img src="{{url('/')}}/templates/bootstrap-blog-1-2-1/distribution/img/blog-post-4.jpeg" alt="..." class="img-fluid"></a></div>
              <div class="post-details">
                <div class="post-meta d-flex justify-content-between">
                  <div class="date meta-last">20 May | 2016</div>
                  <div class="category"><a href="#">Business</a></div>
