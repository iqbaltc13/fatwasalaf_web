    ...
    <div class="uk-width-4-4@l">
        <div class="uk-card">
            ...
            <div class="uk-card-body">
                ...
                <form method="POST" id="form_advanced_validation" class="form-create-master-info-slider" action="{{route('dashboard.master.info-slider.store')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.master.info_slider.form_create')
