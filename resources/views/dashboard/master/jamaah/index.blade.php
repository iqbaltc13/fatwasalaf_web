...
<div class="uk-card uk-margin" id="vue_component">
    ...
    <div class="uk-flex-middle sc-padding sc-padding-medium-ends uk-grid-small" data-uk-grid>
        <div class="uk-flex-1 uk-first-column">
            <h3 class="uk-card-title">&nbsp;&nbsp;&nbsp;List Jamaah</h3>
        </div>
        <div class="uk-width-auto@s">
            <div id="sc-dt-buttons">
                <div class="dt-buttons">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    {{-- <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.master.jamaah.create')}}" ><span data-uk-icon="icon: plus"></span> <span>Tambah Master Pekerjaan</span></a> --}}
...
<script>
    ...
    //         let linkDetail = "{{route('dashboard.master.jamaah.detail-json', ':id')}}";
    ...
    function datatableWithParse(arrParse,message){
        var url = "{{route('dashboard.master.jamaah.datatable')}}";
        url = url + '?';
    ...
    new Vue({
            ...
            methods:{
                ...
                deleteShow:function(id){
                    let linkDelete = "{{route('dashboard.master.jamaah.destroy', ':id')}}";
                ...
                deleteSubmit:function(){
                    ...
                    let route  =  "{{route('dashboard.master.jamaah.destroy', ':id')}}";
