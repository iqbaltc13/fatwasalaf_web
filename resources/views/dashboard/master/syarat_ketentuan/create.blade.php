        ...
        <div class="uk-card">
            <div class="uk-card-header sc-padding">
                <h2 class="uk-card-title">
                    Tambah Master Syarat & Ketentuan
                </h2>
            ...
            <div class="uk-card-body">
                ...
                <form method="POST" id="form_advanced_validation" class="form-create-master-syarat-ketentuan" action="{{route('dashboard.master.syarat-ketentuan.store')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.master.syarat_ketentuan.form_create')
