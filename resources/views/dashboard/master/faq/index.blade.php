...
<div class="uk-card uk-margin" >
    <div class="uk-flex-middle sc-padding sc-padding-medium-ends uk-grid-small" data-uk-grid>
        <div class="uk-flex-1 uk-first-column">
            <h3 class="uk-card-title">&nbsp;&nbsp;&nbsp;List Master Faq</h3>
        </div>
        <div class="uk-width-auto@s">
            <div id="sc-dt-buttons">
                <div class="dt-buttons">
                    <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.master.faq.create')}}" ><span data-uk-icon="icon: plus"></span> <span>Add Master Faq</span></a>
    ...
    <div class="uk-card-body">
        ...
        <div id="modal-detail" data-uk-modal>
            <div class="uk-modal-dialog">
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Detail Master Faq</h2>
                </div>
                <div class="uk-modal-body detail-master-faq">
                    <table id="detail-master-faq-table" class="uk-table uk-table-striped dt-responsive">
                        <tbody>
                            {{-- 
                            <tr>
                                <td></td>
        ...
        <div id="confirm-delete" data-uk-modal>
            <div class="uk-modal-dialog">
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Confirm Delete Master Faq</h2>
                </div>
...
<script>
    ...
    function datatableWithParse(arrParse){
        var url = "{{route('dashboard.master.faq.datatable')}}";
        url = url + '?';
    ...
    function modalDetail(id){
        let linkDetail = "{{route('dashboard.master.faq.detail-json', ':id')}}";
    ...
    function modalDelete(id){
        let linkDelete = "{{route('dashboard.master.faq.destroy', ':id')}}";
            ...
            "columns": [
                    ...
                    
                    {
                        ...
                        render: function(data){
                            let linkEdit = "{{route('dashboard.master.faq.edit', ':id')}}";
