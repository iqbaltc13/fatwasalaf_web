    ...
    <div class="uk-width-3-4@l">
        <div class="uk-card">
            ...
            <div class="uk-card-body">
                    <form method="POST" id="form_advanced_validation" class="form-update-master-faq" action="{{route('dashboard.master.faq.update',['id'=>$data->id])}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.master.faq.form_edit')
