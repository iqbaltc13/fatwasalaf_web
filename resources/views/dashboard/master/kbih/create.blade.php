    ...
    <div class="uk-width-1@l">
        <div class="uk-card">
                ...
                <div class="uk-flex uk-flex-middle">
                    <div class="uk-flex-1 uk-first-column">
                        <h3 class="uk-card-title">
                            <span data-uk-icon="icon:home;ratio:1.4" class="uk-margin-medium-right"></span> Tambah KBIH
                        </h3>
                    </div>
                    <div class="uk-width-auto@s" >
                        <div id="sc-dt-buttons">
                            <div class="dt-buttons">
                                <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.master.kbih.index')}}" ><span data-uk-icon="icon: menu"></span> <span>List KBIH</span></a>
            ...
            <div class="uk-card-body" >
                ...
                @endif
                <form method="POST" id="form_advanced_validation" class="form-create-pekerjaan" action="{{route('dashboard.master.kbih.store')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.master.kbih.form_create')
