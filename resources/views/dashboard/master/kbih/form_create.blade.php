<div id="vue-form-element">
    ...
    <div class="sc-padding-small uk-margin-medium-top">
        ...
        <div class="uk-form-controls">
            <textarea class="uk-textarea" name="alamat" id="alamat" rows="5" data-sc-input="outline"required></textarea>
    ...
    <div class="sc-padding-small uk-margin-medium-top">
        ...
        <div class="uk-form-controls">
            <input class="uk-input" id="email" name="email" type="email" data-sc-input="outline" required>
        </div>
        @error('email')
    ...
    <div class="sc-padding-small uk-margin-medium-top">
        ...
        <div class="uk-form-controls">
            <input class="uk-input" id="latitude" name="latitude" type="text" data-sc-input="outline">
        </div>
        @error('latitude')
    ...
    <div class="sc-padding-small uk-margin-medium-top">
        ...
        <div class="uk-form-controls">
            <input class="uk-input" id="longitude" name="longitude" type="text" data-sc-input="outline">
        </div>
        @error('longitude')
