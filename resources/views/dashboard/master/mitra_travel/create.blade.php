    ...
    <div class="uk-width-4-4@l">
        <div class="uk-card">
            ...
            <div class="uk-card-body">
                ...
                <form method="POST" id="form_advanced_validation" class="form-create-master-mitra-travel" action="{{route('dashboard.master.mitra-travel.store')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.master.mitra_travel.form_create')
