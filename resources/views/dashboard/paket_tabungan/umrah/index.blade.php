...
<div class="uk-card uk-margin" >
    <div class="uk-flex-middle sc-padding sc-padding-medium-ends uk-grid-small" data-uk-grid>
        <div class="uk-flex-1 uk-first-column">
            <h3 class="uk-card-title">&nbsp;&nbsp;&nbsp;List Paket Tabungan Umrah</h3>
        </div>
        <div class="uk-width-auto@s">
            <div id="sc-dt-buttons">
                <div class="dt-buttons">
                    <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.paket-tabungan.umrah.create')}}" ><span data-uk-icon="icon: plus"></span> <span>Add Paket Tabungan Umrah</span></a>
    ...
    <div class="uk-card-body">
        ...
        <div id="modal-detail" data-uk-modal>
            <div class="uk-modal-dialog">
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Detail Paket Tabungan Umrah</h2>
                </div>
                <div class="uk-modal-body detail-paket-tabungan-umrah">
                    <table id="detail-paket-tabungan-umrah-table" class="uk-table uk-table-striped dt-responsive">
                        <tbody>
                            {{-- 
                            <tr>
                                <td></td>
        ...
        <div id="confirm-delete" data-uk-modal>
            <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-body delete-paket-tabungan-umrah">
...
<script>
    ...
    function datatableWithParse(arrParse){
        var url = "{{route('dashboard.paket-tabungan.umrah.datatable')}}";
        url = url + '?';
    ...
    function modalDetail(id){
        let linkDetail = "{{route('dashboard.paket-tabungan.umrah.detail-json', ':id')}}";
        ...
        if(data){
            ...
            for (var key in data.detail_biaya) {
                detailDetailBiaya += '<tr>'+
                                        ...
                                        '<td> Rp '+data.detail_biaya[key].nominal+',-</td>'+
                                      '</tr>'
        ...
        var table = $('.datatable').DataTable({
            ...
            "columns": [
                    ...
                    
                    {
                        ...
                        searchable: false,
                        render: function(data){
                            let linkEdit = "{{route('dashboard.paket-tabungan.umrah.edit', ':id')}}";
