    ...
    <div class="uk-width-3-4@l">
        <div class="uk-card">
            <div class="uk-card-header sc-padding">
                <div class="uk-flex uk-flex-middle">
                    ...
                    <h3 class="uk-card-title">
                       Edit Paket Tabungan Umrah
                    </h3>
                    <div class="uk-width-auto@s" >
                        <div id="sc-dt-buttons">
                            <div class="dt-buttons">
                                {{-- <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.paket-tabungan.umrah.index')}}" ><span data-uk-icon="icon: menu"></span> <span>List Kategori</span></a> --}}
                ...
                <div id="confirm-delete" data-uk-modal>
                    <div class="uk-modal-dialog">
                        <div class="uk-modal-header">
                            <h2 class="uk-modal-title">Confirm Delete Paket Tabungan Umrah</h2>
                        </div>
            ...
            <div class="uk-card-body">
                    <form method="POST" id="form_advanced_validation" class="form-update-paket-tabungan-umrah" action="{{route('dashboard.paket-tabungan.umrah.update',['id'=>$data->id])}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.paket_tabungan.umrah.form_edit')
                    <div id="vue_form_generator">
                        @foreach ($data->detail_biaya as $item)
                            <div class="uk-card-content form-detail-biaya" id="detail-biaya-last-element-{{$item->id}}">
                                ...
                                <a class="sc-button sc-button-danger sc-js-button-wave-light detail-biaya-last-delete-form" @click="deleteDetailBiayaLastForm({{$item->id}})"  dataid="{{$item->id}}" ><span data-uk-icon="icon: trash"></span> <span></span></a>
                                </div>    
                                ...
                                <div class="uk-margin">
                                    <label class="uk-form-label" for="f-empl-recent">Nominal Detail Biaya (Rp)</label>
                                    
                                </div>
                                <div class="uk-margin">
                            
                                    <input class="uk-input"  name="detail_biaya_last_nominal[]" value="{{$item->nominal}}" type="number" data-sc-input="outline" readonly >
                                </div>
                                <div class="uk-margin">
...
<script>
    new Vue({
            ...
            data:{
               ...
               detailBiayaElementIsi            :   '<div class="uk-margin">'+
                                                    ...
                                                    '<div class="uk-margin">'+
                                                        ...
                                                        '<input   class="uk-input"  name="detail_biaya_nominal[]" type="number" data-sc-input="outline" required>'+
                                                    '</div>'+
      ...
      function modalDelete(id){
        let linkDelete = "{{route('dashboard.paket-tabungan.umrah.destroy', ':id')}}";
