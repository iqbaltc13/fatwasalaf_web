    ...
    <div class="uk-width-4-4@l">
        <div class="uk-card">
            ...
            <div class="uk-card-body">
                ...
                <form method="POST" id="form_advanced_validation" class="form-create-paket-tabungan-umrah" action="{{route('dashboard.paket-tabungan.umrah.store')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.paket_tabungan.umrah.form_create')
