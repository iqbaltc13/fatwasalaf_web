        ...
        <div class="uk-width-auto@s">
            <div id="sc-dt-buttons">
                <div class="dt-buttons">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.category.create')}}" ><span data-uk-icon="icon: plus"></span> <span>Tambah Kategori</span></a>
    ...
    new Vue({
            ...
            methods:{
                ...
                deleteShow:function(id){
                    let linkDelete = "{{route('dashboard.category.destroy', ':id')}}";
                ...
                deleteSubmit:function(){
                    ...
                    let route  =  "{{route('dashboard.category.destroy', ':id')}}";
