...
<div class="uk-card uk-margin" id="vue_component">
    ...
    <div class="uk-flex-middle sc-padding sc-padding-medium-ends uk-grid-small" data-uk-grid>
        <div class="uk-flex-1 uk-first-column">
            <h3 class="uk-card-title">&nbsp;&nbsp;&nbsp;List Postingan </h3>
        </div>
        <div class="uk-width-auto@s">
            <div id="sc-dt-buttons">
                <div class="dt-buttons">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.post.create')}}" ><span data-uk-icon="icon: plus"></span> <span>Tambah Postingan</span></a>
    ...
    <div class="uk-card-body">
        ...
        <div id="modal-detail" data-uk-modal>
            <div class="uk-modal-dialog">
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Detail Postingan</h2>
                </div>
        ...
        <div id="confirm-delete" data-uk-modal>
            <div class="uk-modal-dialog">
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Confirm Delete Postingan</h2>
                </div>
...
<script>
    ...
    function modalDetail(id){
            let linkDetail = "{{route('dashboard.post.detail-json', ':id')}}";
    ...
    function datatableWithParse(arrParse,message){
        var url = "{{route('dashboard.post.datatable')}}";
        url = url + '?';
        ...
        var table = $('.datatable').DataTable({
            ...
            "columns": [
                    ...
                    { 
                        ...
                        searchable: false,
                        render: function(data){
                            let linkEdit = "{{route('dashboard.post.edit', ':id')}}";
    ...
    new Vue({
            ...
            methods:{
                ...
                deleteShow:function(id){
                    let linkDelete = "{{route('dashboard.post.destroy', ':id')}}";
                ...
                deleteSubmit:function(){
                    ...
                    let route  =  "{{route('dashboard.post.destroy', ':id')}}";
