...
class CreateTabunganHajisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tabungan_hajis', function (Blueprint $table) {
            ...
            $table->timestamp('tahun_berangkat')->nullable();
            $table->unsignedBigInteger('status_tabungan_haji_id')->nullable();
            ...
            $table->foreign('status_tabungan_haji_id')->references('id')->on('status_tabungan_hajis')->onDelete('set null');
