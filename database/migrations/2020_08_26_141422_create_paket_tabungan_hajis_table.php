...
class CreatePaketTabunganHajisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('paket_tabungan_hajis', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('paket_tabungan_hajis');
    }
}
